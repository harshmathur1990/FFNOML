...
def plot_departure_coefficient_error_assessment(
    ...
    if has_coefficient_kde:
        ...
        # Resolve the logarithmic ticks once, then explicitly reuse both the
        # locations and formatters so every panel displays the same labels.
        fig.canvas.draw()
